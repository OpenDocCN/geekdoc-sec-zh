...
> 原文：[`www.fuzzingbook.org/html/RailroadDiagrams.html`](http://www.fuzzingbook.org/html/RailroadDiagrams.html)

这个笔记本中的代码有助于绘制语法图。它是 [Tab Atkins jr. 的优秀库](https://github.com/tabatkins/railroad-diagrams)（略有定制）的副本，遗憾的是，这个库不是一个 Python 包。
...
<details id="Excursion:-Railroad-diagrams-implementation"><summary>铁路图实现</summary>
