# MitnickSecurity 博客中文翻译

> 原文：[MitnickSecurity ](https://www.mitnicksecurity.com/blog/)
> 
...
* [在线阅读](https://mnsec.flygon.net)
## 下载

### Docker

```
docker pull apachecn0/mitnicksecurity-zh
docker run -tid -p <port>:80 apachecn0/mitnicksecurity-zh
...
```
npm install -g mitnicksecurity-zh
mitnicksecurity-zh <port>
# 访问 http://localhost:{port} 查看文档
```
